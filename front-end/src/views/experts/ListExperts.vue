          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr v-for="expert of experts" :key="expert._id">                
                <td class="pt-3">{{expert.name}}</td>
                <td class="pt-3">Veterinário</td>
                <td class="pt-3">Hospital Veterinário de Coimbra</td>
                <td class="pt-3">{{formatDate(expert.registration_date)}}</td>
                <td>
                  <router-link
  ...
  methods: {
    ...
    generateTemplate(expert) {
      return `
          <h5>${expert.name}</h5>
          <p>
          <b>Profissão:</b> Veterinário <br>
          <b>Local de Trabalho:</b> Hospital Veterinário de Coimbra <br>
